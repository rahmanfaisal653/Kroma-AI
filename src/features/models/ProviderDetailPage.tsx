...
type Form = { id: string; originalId: string; name: string; baseUrl: string; secret: string; chatPath: string; modelsPath: string; chatFormat: string; enabled: boolean; visibility: Visibility[] };
  ...
  return <div className="h-full overflow-y-auto"><div className="max-w-6xl mx-auto p-6 space-y-6 animate-fade-in">
    ...
    <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
        ...
        <Meta label="Chat Format"><span>{provider.chatFormat || 'openai'}</span></Meta>
